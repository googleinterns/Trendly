...
@Component({
  selector: 'app-clusters-side-nav',
  templateUrl: './clusters-side-nav.component.html',
  styleUrls: ['./clusters-side-nav.component.css'],
})
export class ClustersSideNavComponent {
  /**
  ...
  private clustersToShow: Map<number, Cluster>;
