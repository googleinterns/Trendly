...
const EXPECT_OUTPUT : Array<Array<string | number>> = [['8/2010', 50, 'big tech company', '#64B5F6', 50, 'a dangerous virus', '#9575CD', 0, '', '', 0, '', ''],
...
describe('HistogramSectionComponent', () => {
  ...
  it('test creat coulumns', () => {
    ...
    const columns = ['Topic', TERM5, {role: 'tooltip'}, {role: 'style'},TERM1, {role: 'tooltip'}, {role: 'style'}, TERM6, {role: 'tooltip'}, 
