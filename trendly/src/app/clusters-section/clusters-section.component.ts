...
export class ClustersSectionComponent {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (changes['clustersToDisplay'] && this.clustersToDisplay.size > 0) {
  ...
  private addClustersVisualization(): void {
    ...
    console.log(this.clusterIdToLoc);
  ...
  private addCircles(
    ...
    return circleGroup.selectAll('g')
        ...
        .attr('cx', (d) => {console.log(d); return this.clusterIdToLoc.get(d.clusterId).xPosition})
